...
|  | Create virtual server instances to support management. | Deployer node | Configures security group rules to allow access to {{site.data.keyword.cloud_notm}} services. |
