...
{{site.data.keyword.IBM_notm}} Cloud HPC is a product that is deployed to customer resources in the [{{site.data.keyword.cloud_notm}} shared responsibility model](/docs/overview?topic=overview-shared-responsibilities). Start by reviewing the following table of who is responsible for particular cloud resources for {{site.data.keyword.IBM_notm}} Cloud HPC. Next, view more granular tasks for shared responsibilities in the proceeding sections.
...
| Observability | [Shared](#incident-and-ops) |IBM | [Shared](#incident-and-ops) | IBM |
| App networking | You | You | You | You |
| Cluster networking | [Shared](#incident-and-ops) | [Shared](#incident-and-ops) | [Shared](#incident-and-ops) | You |
| Cluster version | [Shared](#incident-and-ops) | [Shared](#incident-and-ops) |  Not applicable |  Not applicable |
...
| HPC software version | Not applicable | [Shared](#change-management) | Not applicable | Not applicable |

{: row-headers}
{: caption="Table. Responsibilities by resource." caption-side="bottom"}

Review the following sections for the specific responsibilities for you and for {{site.data.keyword.IBM_notm}} when you use the {{site.data.keyword.IBM_notm}} Cloud HPC deployable architecture.
...
You and IBM share responsibilities for controlling access to your IBM Cloud HPC instances. For IBM Cloud® Identity and Access Management responsibilities, consult that product's documentation. You are responsible for identity and access management to your application data.
...
IBM is responsible for the security and compliance of HPC Clusters on IBM Cloud. Compliance to industry standards varies depending on the infrastructure provider that you use for the cluster. You are responsible for the security and compliance of any workloads that run in the cluster and your application data.

|  | {{site.data.keyword.IBM_notm}} Responsibilities | Your Responsibilities |
|----------|-----------------------|--------|
|General| * Provide security controls commensurate to best practice for HPC in Cloud.  \n * 
...
IBM is responsible for the recovery of Spectrum Computing on IBM Cloud components in case of disaster. You are responsible for the recovery of the workloads that run the cluster and your application data. If you integrate with other IBM Cloud services such as file, block, object, cloud database, logging, or audit event services, consult those services' disaster recovery information.
