...
{{site.data.keyword.spectrum_short}} enables all three interfaces: UI, API, and CLI. To use the API and CLI interfaces, the Terraform-based automation code is available in [public GitHub repository](https://github.com/terraform-ibm-modules/terraform-ibm-hpc){: external}.
