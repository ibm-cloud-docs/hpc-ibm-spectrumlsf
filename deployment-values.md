...
| `vpc_name` | Name of an existing VPC in which the cluster resources will be deployed. If no value is given, then a new VPC is provisioned for the cluster. [Learn more](https://cloud.ibm.com/docs/vpc). | No | "" |
